                ...
                <tbody>
                    ...
                    while ($data = mysqli_fetch_assoc($query)) { ?>
                        <tr>
                            ...
                            <td><?php echo $data['precio_rebajado']; ?>
            ...
            <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="p_normal">Precio Rebajado</label>
                                <input id="p_normal" class="form-control" type="text" name="p_normal" placeholder="Precio Rebajado" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="p_rebajado">Precio Normal</label>
                                <input id="p_rebajado" class="form-control" type="text" name="p_rebajado" placeholder="Precio Normal" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
